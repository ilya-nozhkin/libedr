...
#define DEFINE_EXTERN_DRIVER_INSTANTIATION(DRIVER)                             \
  extern template class TransactionBuilder<DRIVER##Action>;                    \
  extern template class TransactionInProgress<DRIVER##Action>;                 \
  extern template class TransactionStatus<DRIVER##Action>;                     \
  extern template class Driver<DriverID::DRIVER, DRIVER##Action>;
